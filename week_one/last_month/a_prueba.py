"""
Este scrip es el uso basico del modelo Llama 3.2 instruct, sin instrucciones adicionales, solo
el prompt del sistema y la pregunta del usuario, para ver su comportamiento por defecto. Que
tanto se equivoca es lo que queremos revisar.
"""

...
# Cargar CSV
ruta_csv = os.path.join(os.path.dirname(__file__), "estaciones_sistema.csv")
...
ruta_salida = os.path.join(os.path.dirname(__file__), "estaciones_sobre_mapa_madrid.png")    
